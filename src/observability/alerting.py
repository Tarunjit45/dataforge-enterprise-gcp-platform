...
class AlertEvaluator:
    ...
    ALERT_RULES = {
        ...
        "spark_job_failure": {
            "metric": "spark_job_status",
            "op": "==",
            "threshold": "FAILED",
            "severity": "CRITICAL",
        },
        "bigquery_load_failure": {
            "metric": "bigquery_job_status",
            "op": "==",
            "threshold": "FAILED",
            "severity": "HIGH",
        },
        ...
        "dq_score_below_threshold": {
            "metric": "data_quality_score_percent",
            "op": "<",
            "threshold": 70.0,
            "severity": "HIGH",
        },
        "high_quarantine_ratio": {
            "metric": "quarantine_rate_percent",
            "op": ">",
            "threshold": 10.0,
            "severity": "MEDIUM",
        },
    ...
    def evaluate_metric(self, alert_name: str, current_value: Any) -> Optional[Dict[str, Any]]:
        ...
        if is_fired:
            ...
            logger.critical(
                f"ALERT FIRED [{alert_name}]: {current_value} {op} {threshold}",
                error_category="ALERT_TRIGGERED",
            )
